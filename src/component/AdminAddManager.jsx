...
import { ManagerAuthAction } from './../Redux/Action/AdminAction';
...
export default function AdminAddManager() {
    ...
    const [totalTeamHandleling, setTotalTeamHandleling] = useState('')
    // useEffect(() => {
    //     if (managerRegister)
    //         props.history.push("/");
    ...
    const managerRegisterClickHandler = async (e) => {
        e.preventDefault();
        if (password === confirmPassword) {
            dispatch(ManagerAuthAction(
                {
                    firstName, lastName, mobileNo, gender, email, password,
                    area, city, state, zip, salary, experience, bonus, dateOfJoining,
                    qualification, adharNumber, totalTeamHandleling
                }));
                        ...
                        <div className="col-md-6">
                            <div className="card shadow-lg">
                                <div className="card-header bg-dark">
                                    <h3 className="text-center text-white font-italic"  >Manager Registration</h3>
                                </div>
                                <div className="card-body">
                                    <form>
                                        ...
                                        <div className="form-group">
                                            <label htmlfor="lastName">Bonus</label>
                                            <input type="text" className="form-control" onChange={e => setBonus(e.target.value)} />
                                        </div>
                                        <div className="form-group">
                                            <label htmlfor="lastName">Date Of Joining</label>
                                            <input type="text" className="form-control" onChange={e => setDateOfJoining(e.target.value)} />
                                        </div>
                                        <div className="form-group">
                                        ...
                                        <div className="form-group">
                                            <label htmlfor="lastName">Adharnumber</label>
                                            <input type="text" className="form-control" onChange={e => setAdharnumber(e.target.value)} />
                                        </div>
                                        <div className="form-group">
                                            <label htmlfor="lastName">Number Of team members</label>
                                            <input type="text" className="form-control" onChange={e => setTotalTeamHandleling(e.target.value)} />
                                        </div>
                                        <div className="form-group">
                                        ...
                                        <button type="submit" className="btn btn-dark btn-block h-10" onClick={managerRegisterClickHandler}>Register</button>
                                    </form>
                                </div>
                            </div>
                        </div>
